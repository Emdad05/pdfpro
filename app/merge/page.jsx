        ...
        <div className="space-y-4">
          <div className="card p-5">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-display font-semibold text-white">Files ({files.length})</h3>
              <label className="text-sm text-gold hover:text-gold cursor-pointer transition-colors font-medium flex items-center gap-1">
              ...
              {files.map(({ file, id }, i) => (
                <div key={id} className="file-item justify-between">
                  <div className="flex items-center gap-3 min-w-0">
                    <span className="w-7 h-7 rounded-lg flex items-center justify-center text-xs font-bold flex-shrink-0 font-display"
          ...
          {done ? (
            <div className="success-card">
              ...
              <p className="font-display font-semibold text-gold text-lg mb-3">Merged successfully!</p>
              <button onClick={() => { setFiles([]); setDone(false); }} className="btn-ghost text-sm">Merge more files</button>
            </div>
          ) : (
            <div className="flex gap-3">
              ...
              <button onClick={() => setFiles([])} className="btn-ghost">Reset</button>
            </div>
          )}
